...
def run_edge_detector(input_image_path):
    # Load a color image in grayscale

    im = cv2.imread(input_image_path, 0)

    output_picture_zero_crossing_edges0 = input_image_to_edge_map(6, im)
    return save_edge_maps(input_image_path, 0, output_picture_zero_crossing_edges0)
...
if __name__ == '__main__':
    ...
    output_picture_zero_crossing_edges0 = run_edge_detector(args['image'])
